...
```
sample_size_calculator_ga.html   # Main web tool
sample_size_calculator.xlsx      # Excel version
...
The tool is a **static webpage** and can be hosted on:

* GitHub Pages
* Netlify
* Internal company servers

Or simply open the HTML file locally.
...
| Event     | Trigger                    |
| --------- | -------------------------- |
| calculate | When user clicks calculate |

View in GA:

```
Reports → Engagement → Events → calculate
```
...
### Why is nB extremely large?

If **nA is too small**, the required **nB** increases to maintain statistical power.
